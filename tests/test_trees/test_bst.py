...
def test_bst_simple():
    ...
    assert bst._root.get_right().get_left() is None
    assert bst._root.get_right().get_right() is None
...
def test_bst_from_iterable():
    ...
    assert bst._root.get_left().get_left() is None
    ...
    assert (
        bst.to_list()
        == [19, 7, 22, 10, 20, 30, 9, 12, 25, 11, 14]
    )
    assert (
    ...
    assert (
        ...
        == [9, 11, 14, 12, 10, 7, 20, 25, 30, 22, 19]
    )
    assert (
